...
ADMINS = (
    ('Admin as usual', 'admin@domain.com'),
)

MANAGERS = ADMINS

DATABASE_ENGINE = 'sqlite3'           # 'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'oracle'.
DATABASE_NAME = 'school_history.db'             # Or path to database file if using sqlite3.
...
SECRET_KEY = 'm#&yq9l$6j2q-$=&^ag_fw6xinxu*%x9qn1c=y$4cb+$99j*fv'
